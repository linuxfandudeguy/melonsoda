...
| -------------------------------- | ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| index.html                       | bundled version of the website (static)                                  | works offline<br>fast load (no external requests)<br>simple deployment                   | does not update automatically<br>requires manual redownload for changes                         | [https://example.com/download/index.html](https://example.com/download/index.html)                                   |
| selfupdating.html                | dynamically updates using axios                       | always fetches latest version<br>no external cdn dependency                              | large file size (unminified axios)<br>slower initial load                                       | [https://example.com/download/selfupdating.html](https://example.com/download/selfupdating.html)                     |
...
| selfupdating-protected.html      | self-updating version with password protection (password: homeworksucks) | restricts access from admins/teacherss<br>still updates dynamically                    | uses unminified axios (large size)<br>viewer-cli does not work<br> | [https://example.com/download/selfupdating-protected.html](https://example.com/download/selfupdating-protected.html) |
